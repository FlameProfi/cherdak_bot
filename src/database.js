...
function saveUser(user) {
  const { telegram_id, fusion_client_id, phone, full_name, total_spent, current_level } = user;
  return db.prepare(`
    INSERT INTO users (telegram_id, fusion_client_id, phone, full_name, total_spent, current_level, last_updated)
  ...
  `).run(telegram_id, fusion_client_id, phone, full_name, total_spent, current_level);
}
